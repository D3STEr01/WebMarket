...
$sql = $sql . " WHERE stt_produto = 'Disponível' AND classificacao = 'Alimentícios'";
...
<html>
<head>
	<title>Alimentícios</title>
		<meta name="viewport" content="width=device-width, initial-scale=1">
	<link rel="shortcut icon" href="logo.ico" type="image/x-icon" />
	<link rel="stylesheet" type="text/css" href="laticiniosCss.css">
</head>
<body>
	<!-- MENU SUPERIOR -->
		<div class="topo">
...
<div>
	...
	?>
				<div class="produtos">
					<td >
						<a href="#"><img src="imagens/<?PHP print $nome; ?>.jpg" width="200" height="250" border="0" /></a><br />
					<td >
						<span class="nome"><?PHP print $nome; ?></span><br />
						<span class="valor">R$ <?PHP print number_format($valor,2,',','.'); ?></span><br />
						<br>
						<button class="comp">Comprar</button>
						<a href="cesta.php?produto=<?PHP print $prod_id; ?>"><button type="submit" class="carr">Carrinho</button></a>
					</td>	
				</td>
				</div>
	<?PHP
	...
	?>
				...
				<td >
					<a href="#">
						<img src="imagens/<?PHP print $nome; ?>.jpg" width="200" height="250" border="0" />
					</a><br />
				</td>
				<td >
					<span class="nome"><?PHP print $nome; ?></span><br />
